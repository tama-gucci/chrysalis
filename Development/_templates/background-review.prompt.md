...
Name the exact reviewed candidate in the result. Acceptance applies only to that candidate and scope. Any later code change or integration conflict invalidates this receipt until reviewed again. Acceptance is not proof of deployment or a working personal runtime.
